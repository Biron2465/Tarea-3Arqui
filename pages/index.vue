<template>
  <div class="container my-5">
    ...
    <div class="text-center mb-5">
      <h1 class="display-3 font-weight-bold text-primary">Bienvenido a nuestro Catálogo de Aviones</h1>
      <p class="lead text-secondary">Explora nuestras secciones y descubre detalles fascinantes sobre los aviones, fabricantes, y aerolíneas.</p>
    </div>
    <main>
      <div class="row g-4">
    ...
    const checkSnipcartLoaded = setInterval(() => {
      if (window.Snipcart && window.Snipcart.ready) {
        ...
        window.Snipcart.init({
          publicApiKey: 'MWVmZGE4NjEtYTdlNC00ZmIzLTk2MTEtMmIxYzA2MmU1N2EzNjM4NjY3MTE4MjU1ODkxNjE0',
...
<style scoped>
/* Ajuste de los colores y separación de botones */
