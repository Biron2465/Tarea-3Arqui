<template>
  <div class="container my-5">
    ...
    <div class="text-center mb-5">
      <h1 class="display-3 font-weight-bold text-primary">Lista de Aerolíneas</h1>
    </div>
    <main>
      <div class="row g-4">
        <li v-for="aerolinea in aerolineas" :key="aerolinea.nombre" class="col-12 col-md-6 col-lg-4">
          <div class="card h-100 shadow-sm border-light">
            <div class="card-body text-center p-4">
              <h5 class="card-title text-dark font-weight-bold mb-4">{{ aerolinea.nombre }}</h5>
              <nuxt-link :to="`/aerolineas/${aerolinea.nombre}`" class="btn btn-info mb-3">
                Ver detalles
              </nuxt-link>
              <div>
                <button
